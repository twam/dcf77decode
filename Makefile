...
#LDFLAGS = -T /usr/lib64/binutils/avr/2.18/ldscripts/avr5.x -Wl,-Map=$(TARGET).map,--cref
LDFLAGS += $(EXTMEMOPTS)
...
OBJ = $(patsubst %.c,%.o,$(patsubst %.cpp,%.o,$(SRC))) $(patsubst %.S,%.o,$(ASRC))

# Define all listing files.
LST = $(patsubst %.c,%.lst,$(patsubst %.cpp,%.lst,$(SRC))) $(patsubst %.S,%.lst,$(ASRC))
...
clean_list :
	...
	$(REMOVE) $(OBJ)
	$(REMOVE) $(LST)
	$(REMOVE) $(patsubst %.c,%.s,$(patsubst %.cpp,%.s,$(SRC)))
